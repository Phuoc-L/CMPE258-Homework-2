...
if __name__ == "__main__":
    ...
    parser.add_argument('--video_path', type=str, default='video.mp4', help='Path to the input video file')
    ...
    parser.add_argument('--method', type=str, default='both', choices=['scene_change', 'interval', 'both'], help='Method to extract frames: scene_change, interval, or both')
    parser.add_argument('--model_name_path', type=str, default="yolov8n.pt", help='Model to use for object detection, panoptic segmentation: yolo, shi-labs/oneformer_coco_swin_large, facebook/mask2former-swin-large-cityscapes-panoptic, facebook/mask2former-swin-large-coco-panoptic')
    parser.add_argument('--segmentation_type', type=str, default='grounding', choices=['universal', 'grounding'], help='Type of segmentation to perform')
    parser.add_argument('--task', type=str, default='semantic', choices=['semantic', 'instance', 'panoptic'], help='Type of tasks to perform')#task = "semantic" #task_inputs=["panoptic"], "instance" semantic
    parser.add_argument('--text_prompt', type=str, default='person, car, bicycle, motorcycle, truck, traffic light',  help='Text prompt for GroundingDINO (comma-separated objects)')
    ...
    parser.add_argument('--skip_inference', default=True, help='Only extract frames and skip inference')
    ...
    if args.skip_inference:
        print("Skipping inference and only extracting frames.")
        sys.exit(0)
